...
SQL;
          ...
          exit;
            ...
            if ($result->num_rows > 0 ) {
              $html .= '<div><h6>You are able to add a new contest instance <a href="#">here</a>.</h6></div>';
              ...
              $html .= '<div><h4>There are no active contests currently.<br><small>You are able to add a new contest instance <a href="#">here</a>.</small></h4></div>';
            }
            echo $html;
  }